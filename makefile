...
# coq_makefile -o makefile assertion.v language.v semantic.v state.v triple.v util.v 
#
...
.merlin:
	...
	@echo "B /Users/luluwang/Desktop/Github/seplogic" >> .merlin
	@echo "S /Users/luluwang/Desktop/Github/seplogic" >> .merlin
